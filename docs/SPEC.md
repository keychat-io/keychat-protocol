# Keychat Protocol Specification

> This document is the authoritative specification for the Keychat protocol. It is continuously updated as implementation progresses and bugs are discovered. All implementations MUST conform to this spec.

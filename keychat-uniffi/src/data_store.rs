...
impl KeychatClient {
    pub async fn get_identities(&self) -> Result<Vec<IdentityInfo>, KeychatUniError> {
        self.app
            .get_identities()
            .await
            .map(|v| v.into_iter().map(convert_identity_info).collect())
            .map_err(Into::into)
    }
    ...
    pub async fn update_app_identity_ffi(
        ...
        self.app
            .update_app_identity(pubkey_hex, name, avatar, is_default)
            .await
            .map_err(Into::into)
    }
    ...
    ) -> Result<Vec<RoomInfo>, KeychatUniError> {
        self.app
            .get_rooms(identity_pubkey)
            .await
            .map(|v| v.into_iter().map(convert_room_info).collect())
            .map_err(Into::into)
    }
    ...
    pub async fn should_auto_download(&self, file_size: u64) -> Result<bool, KeychatUniError> {
        self.app
            .should_auto_download(file_size)
            .await
            .map_err(Into::into)
    }
    ...
    pub async fn get_messages(
        ...
        self.app
            ...
            .await
            .map(|v| v.into_iter().map(convert_message_info).collect())
            .map_err(Into::into)
    }
    pub async fn get_message_by_msgid(
        ...
        self.app
            .get_message_by_msgid(msgid)
            .await
            .map(|v| v.map(convert_message_info))
            .map_err(Into::into)
    }
    pub async fn get_messages_initial(
        ...
        self.app
            .get_messages_initial(room_id, context_count)
            .await
            .map(|v| v.into_iter().map(convert_message_info).collect())
            .map_err(Into::into)
    }
    pub async fn get_messages_before(
        ...
        self.app
            .get_messages_before(room_id, before_ts, limit)
            .await
            .map(|v| v.into_iter().map(convert_message_info).collect())
            .map_err(Into::into)
    }
    ...
    pub async fn get_contacts(
        ...
        self.app
            .get_contacts(identity_pubkey)
            .await
            .map(|v| v.into_iter().map(convert_contact_info).collect())
            .map_err(Into::into)
    }
    pub async fn update_contact_petname(
        ...
        self.app
            .update_contact_petname(pubkey, identity_pubkey, petname)
            .await
            .map_err(Into::into)
    }
    ...
    pub async fn save_app_contact_ffi(
        ...
        self.app
            .save_app_contact_record(pubkey, npubkey, identity_pubkey, name)
            .await
            .map_err(Into::into)
    }
    ...
    pub async fn increment_app_room_unread_ffi(
        ...
        self.app
            .increment_app_room_unread_record(room_id)
            .await
            .map_err(Into::into)
    }
...
fn convert_identity_info(i: keychat_app_core::IdentityInfo) -> IdentityInfo {
    IdentityInfo {
        npub: i.npub,
        nostr_pubkey_hex: i.nostr_pubkey_hex,
        name: i.name,
        avatar: i.avatar,
        index: i.index,
        is_default: i.is_default,
        created_at: i.created_at as u64,
    }
}
fn convert_room_info(r: keychat_app_core::RoomInfo) -> RoomInfo {
    RoomInfo {
        ...
        status: RoomStatus::from_i32(r.status.to_i32()),
        room_type: RoomType::from_i32(r.room_type.to_i32()),
        name: r.name,
        avatar: r.avatar,
...
fn convert_message_info(m: keychat_app_core::MessageInfo) -> MessageInfo {
    MessageInfo {
        ...
        is_read: m.is_read,
        status: MessageStatus::from_i32(m.status.to_i32()),
